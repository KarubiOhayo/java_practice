...
// 현재 등록된 회원 수가 10명일 때
//        1. 회원등록 (현재 인원 10명으로 회원가입 불가) ➔ 선택하면 다시 입력
//        2. 회원 검색 ➔ searchMember()
//        3. 회원 정보 수정 ➔ updateMemner()
//        4. 회원 삭제 ➔ deleteMember()
//        5. 모두 출력 ➔ printAll()
...
// 중복되지 않도록 mc의 checkId()메서드를 통해서 중복 검사를 함
...
// 메뉴 번호에 따라 각 메서드로 이동되며 9번을 입력했을 경우
...
// mc의 searchId() 메서드의 매개변수로 넘김, 반환 값에 따라
...
// mc의 searchName() 메서드의 매개변수로 넘김, 반환 값에 따라
// 검색 결과 없으면 “검색 결과가 없습니다.” 출력 후 mainMenu()로 돌아감
// 검색 결과가 있으면 “찾으신 회원 조회 결과입니다.” 출력 후
// 회원 검색 결과 출력
    }
...
// 검색할 아이디를 사용자에게 입력 받고 입력 받은 데이터를
// mc의 searchEmail() 메서드의 매개변수로 넘김, 반환 값에 따라
// 검색 결과 없으면 “검색 결과가 없습니다.” 출력 후 mainMenu()로 돌아감
// 검색 결과가 있으면 “찾으신 회원 조회 결과입니다.” 출력 후
// 회원 검색 결과 출력
    }
...
// mc의 updatePassword() 메서드의 매개변수로 넘김, 반환 값에 따라
...
// mc의 updateName() 메서드의 매개변수로 넘김, 반환 값에 따라
// 검색결과 없으면 “존재하지 않는 아이디입니다.” 출력, mainMenu()로 감
// 검색 결과가 있으면 “수정이 성공적으로 되었습니다.” 출력 후
// mainMenu()로 돌아감
    }
...
// mc의 updateEmail() 메서드의 매개변수로 넘김, 반환 값에 따라
// 검색결과 없으면 “존재하지 않는 아이디입니다.” 출력, mainMenu()로 감
// 검색 결과가 있으면 “수정이 성공적으로 되었습니다.” 출력 후
// mainMenu()로 돌아감
    }
...
// mc의 delete() 메서드의 매개변수로 넘김, 반환 값에 따라
// 검색결과 없으면 “존재하지 않는 아이디입니다.” 출력, mainMenu()로 감
...
// mc의 delete() 메서드 호출, “성공적으로 삭제하였습니다.” 출력 후
// mainMenu()로 돌아감
    }
    public void printAll(){
// mc의 printAll() 메서드의 반환 값을 가지고 저장된 회원을 출력하는데
